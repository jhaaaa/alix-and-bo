...
Based on [this proposal](#proposal-toward-a-global-cast-of-characters-for-cryptography), here is a list of updated character names for use in cryptography discussions. See also: [Origins and meanings of updated names](#origins-and-meanings-of-updated-names).
...
In 1978, when Rivest, Shamir, and Adleman published their paper, there was no internet. Digital communication was a concept of science fiction. Business was done in person or over the phone.
...
> **Get the list**  
> For the list of updated names, see [A global cast of characters for cryptography](#a-global-cast-of-characters-for-cryptography). 

### How were the updated names selected?

Each updated name was selected based on the following criteria:
...
- Includes at least the first two letters of the original character or role name. This is meant to help with recall when transitioning to use the updated names.
...
- Thank you to the "Google developer documentation style guide" for providing their excellent list of [Example person names](https://developers.google.com/style/examples#example-person-names), which served as inspiration for this work.
